...
Branche : `feat/ui-v4`. Modèle prévu : Luna, raisonnement medium.
Mission : porter authentification suivant ST1 V4, sans modifier les contrats API.
Références Pencil vérifiées le 17/09/2026 : 01 : CA1IZ; 02 : OuSuY; 20 : VOZ4K. Revalider les noms avant lecture ciblée.
Lire PLAN.md, ce contrat, ../00-socle/PASSATION.md, puis uniquement notes pertinentes du vault et code utile.

Fichiers autorisés (préfixe SportTracker.App sauf indication) : Pages/Login.razor, Pages/Register.razor, Pages/NotFound.razor.
...
Réception : Préserver login/register, erreurs Identity, redirections et authentification.
