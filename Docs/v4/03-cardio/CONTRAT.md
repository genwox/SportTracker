...
Mission : porter cardio suivant ST1 V4, sans modifier les contrats API.
Références Pencil vérifiées le 17/09/2026 : 07 : WwhBX; 08 : AakVz; 09 : uyZUT; 25 : uTCoj. Revalider les noms avant lecture ciblée.
Lire PLAN.md, ce contrat, ../02-musculation/PASSATION.md, puis uniquement notes pertinentes du vault et code utile.

Fichiers autorisés (préfixe SportTracker.App sauf indication) : Pages/CardioSessions.razor*, Pages/NewCardioSession.razor*, Pages/CardioSessionDetail.razor*.
...
Réception : Erreur réseau : valeurs conservées et nouvelle tentative ; écran 25.
