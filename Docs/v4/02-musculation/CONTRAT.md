...
Mission : porter musculation suivant ST1 V4, sans modifier les contrats API.
Références Pencil vérifiées le 17/09/2026 : 04 : XWc5M; 05 : RhUlZ; 06 : O63J6l. Revalider les noms avant lecture ciblée.
Lire PLAN.md, ce contrat, ../01-authentification/PASSATION.md, puis uniquement notes pertinentes du vault et code utile.

Fichiers autorisés (préfixe SportTracker.App sauf indication) : Pages/WorkoutSessions.razor*, Pages/NewWorkoutSession.razor*, Pages/WorkoutSessionDetail.razor*.
...
Réception : Conserver exercices/séries dynamiques et toutes les valeurs après erreur.
