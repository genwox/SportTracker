# Lot 7 — historique-exercice

Branche : `feat/ui-v4`. Modèle prévu : Luna, raisonnement medium.
Mission : porter historique-exercice suivant ST1 V4, sans modifier les contrats API.
Références Pencil vérifiées le 17/09/2026 : 16 : H3oTC. Revalider les noms avant lecture ciblée.
Lire PLAN.md, ce contrat, ../06-live/PASSATION.md, puis uniquement notes pertinentes du vault et code utile.

Fichiers autorisés (préfixe SportTracker.App sauf indication) : Pages/ExerciseHistory.razor*.
...
Réception : Graphique 1RM et séries réelles ; états vide/chargement/erreur.
